...
const EditModal = ({ visible, onClose, onSubmit,BranchData }) => {
    ...
    <Modal visible={visible} animationType="slide">
      <View style={styles.modalContent}>
        ...
        <TextInput
          style={styles.input}
          placeholder="Name"
          defaultValue={BranchData != null?BranchData.name : ''}
          // onChangeText={value => setEditedData({...editedData, name: value})}
        />
        <TextInput
          style={styles.input}
          placeholder="Location"
          defaultValue={BranchData != null?BranchData.location : ''}
          // onChangeText={value => setEditedData({...editedData, location: value})}
        />
        <TextInput
          style={styles.input}
          placeholder="Users"
          defaultValue={BranchData != null?BranchData.users : ''}
        ...
        <TextInput
          ...
          defaultValue={BranchData != null?BranchData.phoneNumber : ''}
  ...
  const handleCreateClass = async (classDetails) => {
    ...
    <LinearGradient colors={['#0000', '#0000']} style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.title}>Hazmieh Branch Details</Text>
        {branchData.map(branch => (
          <TouchableOpacity
            key={branch._id}
            style={styles.branchCard}
            onPress={() => {
              console.log("Setting On Press")
          ...
          >
            ...
            {/* <Text style={styles.branchInfo}>Profit: ${branch._id}</Text> */}
...
export default Branch3SpecificScreen;
